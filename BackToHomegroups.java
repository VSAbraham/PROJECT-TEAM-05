...
public class BackToHomegroups {
    ...
    @Test(priority = 2, groups = {"checkout", "regression"})
    ...
    @Test(priority = 3, groups = {"checkout", "regression"})
    ...
    @Test(priority = 4, groups = {"verification", "smoke"})
    ...
    @Test(priority = 5, groups = {"logout", "regression"})
